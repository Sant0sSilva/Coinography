...
Future<CoinAPI> fetchCoinData(String coinTitle, ) async {
  String urlStart = 'https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=';
  String urlEnd = '&order=market_cap_desc&per_page=1&page=1&sparkline=false';

  final response = await http.get(Uri.parse(
      '$urlStart${coinTitle}$urlEnd'));
  ...
  return
    CoinAPI(
        ...
        priceChange24: jsonResponse[0]['price_change_24h'].toDouble(),
